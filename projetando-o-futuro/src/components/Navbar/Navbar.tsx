...
//         <li>
//           <Link to="/projects">
//             <span className={linkClass}>Projetos</span>
//           </Link>
//         </li>
//         <li>
...
//         <li>
//           <span
//             onClick={() => handleNavClick("como-ajudar")}
//             className={linkClass}
//           >
//             Como Ajudar
//           </span>
...
//       <div
//         className="md:hidden text-3xl font-extrabold cursor-pointer select-none"
...
//               <li>
//                 <button
//                   className="uppercase font-extrabold text-green-primary border-[3px] border-green-primary px-6 py-2 hover:bg-green-primary hover:text-white transition-colors tracking-wide cursor-pointer"
//                   onClick={() => setIsMenuOpen(false)}
//                 >
//                   Sair
//                 </button>
...
function Navbar() {
  ...
  // 1. Verifica se existe um token salvo para definir se está autenticado
  const token = localStorage.getItem("token");
  const isAuthenticated = !!token; // Transforma em booleano (true se existir, false se for null)
  ...
  const handleLogout = () => {
    ...
    setIsMenuOpen(false);
    window.location.href = "/"; // Força recarregamento para a home limpando os estados
  };
      ...
      <ul className="hidden md:flex items-center gap-8">
        ...
        {isAuthenticated ? (
          <>
            ...
            <li>
              {/* 3. Adicionado o onClick para o Logout */}
              <button
                onClick={handleLogout}
                className="uppercase font-extrabold text-green-primary border-[3px] border-green-primary px-6 py-2 hover:bg-green-primary hover:text-white transition-colors tracking-wide ml-2 cursor-pointer"
              >
                Sair
              </button>
            </li>
